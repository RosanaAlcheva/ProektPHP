...
#vinarii
v1 = Vinarija.create(ime: 'Tikves', region: 'Tikveski', grad: 'Kavadarci', godina: 1885, opis: 'Mnogu ubava vinarijas', veb_strana: 'htttp://tikves.com.mk', slika: 'tikves.png')
v2 = Vinarija.create(ime: 'Stobi', region: 'Gradsko', grad: 'Gradsko', godina: 1885, opis: 'Mnogu ubava vinarijas', veb_strana: 'htttp://www.stobiwinery.mk', slika: 'stobi.png')
...
v6 = Vinarija.create(ime: 'Povardarie', region: 'Negotino', grad: 'Negotino', godina: 1963, opis: 'Mnogu ubava vinarijas', veb_strana: '/', slika: 'povardarie.png')
